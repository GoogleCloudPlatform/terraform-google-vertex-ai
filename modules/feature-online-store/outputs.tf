...
output "feature_online_store_id" {
  ...
  value       = google_vertex_ai_feature_online_store.feature_online_store.id
}

output "feature_online_store_name_output" {
  description = "The name of the created Vertex AI Feature Online Store."
  value       = google_vertex_ai_feature_online_store.feature_online_store.name
}

output "psc_service_attachment" {
  description = "The service attachment URI for the Private Service Connect endpoint."
  value       = google_vertex_ai_feature_online_store.feature_online_store.dedicated_serving_endpoint[0].service_attachment
}
